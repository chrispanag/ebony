...
export class Message {
    ...
    constructor(options: MessageOptions = {}) {
        ...
        if (!(text || attachment)) throw new Error('Message: No message content is specified!');
        if (text && attachment) throw new Error("Message: A message can't have text & attachment");
