 ...
 */
class ButtonTemplate extends attachments_1.TemplateAttachment {
    /**
 ...
 * @extends TemplateAttachment
 */
class GenericTemplate extends attachments_1.TemplateAttachment {
    /**
 ...
 * @extends TemplateAttachment
 */
class ListTemplate extends attachments_1.TemplateAttachment {
    /**
 ...
 * @extends TemplateAttachment
 */
class MediaTemplate extends attachments_1.TemplateAttachment {
    /**
 ...
 */
function listElement({ title = null, subtitle = null, image_url = null, action = null, buttons = [] }) {
    let serializedButtons = [];
    if (buttons.length > 0) {
        serializedButtons = buttons.map((b) => b.serialize());
    }
