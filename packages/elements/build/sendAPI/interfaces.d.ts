...
export declare function isObjectPayload(payload: string | {}): payload is {};
...
export declare type SerializedMessage = SerializedAttachmentMessage | SerializedTextMessage;
