...
function senderFactory(fb) {
     ...
     * @param {object} options - The sending options (OPTIONAL)
     * @param {string} options.tag - The messaging tag used to send the message
     * @param {string} options.notification_type - The notification type of the message
