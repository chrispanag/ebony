    ...
    exec() {
        ...
        return {
            _actions: [],
                ...
                const resolved = Promise.all(this._actions);
                this._actions = [];
                return resolved;
            },
            send: (_id, message, options = {}) => {
                this._actions.push(that._sender(_id, message, options));
                return this;
            },
            wait: millis => {
                this._actions.push(timeoutPromise(millis));
                return this;
            },
            types: id => {
                this._actions.push(that.fb.startsTyping(id));
                return this;
            }
        }
    }
